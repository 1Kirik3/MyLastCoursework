...
// MyLastCoursework.cpp: определяет поведение классов для приложения.
//
...
// CMyLastCourseworkApp

BEGIN_MESSAGE_MAP(CMyLastCourseworkApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMyLastCourseworkApp

CMyLastCourseworkApp::CMyLastCourseworkApp()
{
...
// Единственный объект CMyLastCourseworkApp

CMyLastCourseworkApp theApp;


// Инициализация CMyLastCourseworkApp

BOOL CMyLastCourseworkApp::InitInstance()
{
